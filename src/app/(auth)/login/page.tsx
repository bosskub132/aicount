  ...
  return (
    <div>
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-slate-500">Sign in to your AiCount account</p>
      </div>
      ...
      {inviteToken && (
        <div className="mb-6 flex items-start gap-2.5 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3">
          ...
          <p className="text-sm text-blue-800">Sign in to accept your workspace invitation.</p>
        </div>
      )}
